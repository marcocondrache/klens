...
export type ThroughputPointFieldsFragment = { timestamp: string, bytesIn: number, bytesOut: number, messages: number };
...
export type ClusterThroughputQuery = { clusterThroughput: Array<{ timestamp: string, bytesIn: number, bytesOut: number, messages: number }> };
...
export type TopicThroughputQuery = { topicThroughput: Array<{ timestamp: string, bytesIn: number, bytesOut: number, messages: number }> };
...
export type ConsumerGroupLagSubscription = { consumerGroupLag: { id: string, state: ConsumerGroupState, protocol: string, coordinator: number, topics: Array<string>, lag: number, members: Array<{ id: string, clientId: string, host: string, assignments: Array<{ topic: string, partitions: Array<number> }> }>, offsets: Array<{ topic: string, partition: number, currentOffset: number, endOffset: number, lag: number, memberId: string | null }> } };
