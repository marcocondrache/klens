...
export type ClusterFieldsFragment = { name: string, label: string, clusterId: string, bootstrapServers: Array<string>, securityProtocol: SecurityProtocol, version: string, status: ClusterStatus, brokerCount: number, topicCount: number, partitionCount: number, consumerGroupCount: number, underReplicatedPartitions: number, offlinePartitions: number, messageCount: number, sizeBytes: number, bytesInPerSec: number, bytesOutPerSec: number };

export type BrokerFieldsFragment = { id: number, host: string, port: number, rack: string | null, controller: boolean, partitionCount: number, leaderCount: number, logDirSizeBytes: number, bytesInPerSec: number, bytesOutPerSec: number };

export type PartitionFieldsFragment = { id: number, leader: number, replicas: Array<number>, isr: Array<number>, lowWatermark: number, highWatermark: number, sizeBytes: number };

export type TopicFieldsFragment = { name: string, internal: boolean, replicationFactor: number, messageCount: number, sizeBytes: number, cleanupPolicy: CleanupPolicy, retentionMs: number, consumerGroups: Array<string>, bytesInPerSec: number, messagesPerSec: number, underReplicated: boolean, partitions: Array<{ id: number, leader: number, replicas: Array<number>, isr: Array<number>, lowWatermark: number, highWatermark: number, sizeBytes: number }> };

export type ConfigEntryFieldsFragment = { name: string, value: string | null, source: ConfigSource, readOnly: boolean, sensitive: boolean, documentation: string | null };
...
export type TopicRecordFieldsFragment = { topic: string, partition: number, offset: number, timestamp: number, key: string | null, value: string | null, sizeBytes: number, compression: Compression, headers: Array<{ key: string, value: string }> };
...
export type BrokersQuery = { brokers: Array<{ id: number, host: string, port: number, rack: string | null, controller: boolean, partitionCount: number, leaderCount: number, logDirSizeBytes: number, bytesInPerSec: number, bytesOutPerSec: number }> };
...
export type BrokerQuery = { broker: { id: number, host: string, port: number, rack: string | null, controller: boolean, partitionCount: number, leaderCount: number, logDirSizeBytes: number, bytesInPerSec: number, bytesOutPerSec: number } | null };
...
export type BrokerConfigsQuery = { brokerConfigs: Array<{ name: string, value: string | null, source: ConfigSource, readOnly: boolean, sensitive: boolean, documentation: string | null }> };
...
export type TopicsQuery = { topics: Array<{ name: string, internal: boolean, replicationFactor: number, messageCount: number, sizeBytes: number, cleanupPolicy: CleanupPolicy, retentionMs: number, consumerGroups: Array<string>, bytesInPerSec: number, messagesPerSec: number, underReplicated: boolean, partitions: Array<{ id: number, leader: number, replicas: Array<number>, isr: Array<number>, lowWatermark: number, highWatermark: number, sizeBytes: number }> }> };
...
export type TopicQuery = { topic: { name: string, internal: boolean, replicationFactor: number, messageCount: number, sizeBytes: number, cleanupPolicy: CleanupPolicy, retentionMs: number, consumerGroups: Array<string>, bytesInPerSec: number, messagesPerSec: number, underReplicated: boolean, partitions: Array<{ id: number, leader: number, replicas: Array<number>, isr: Array<number>, lowWatermark: number, highWatermark: number, sizeBytes: number }> } | null };
...
export type TopicConfigsQuery = { topicConfigs: Array<{ name: string, value: string | null, source: ConfigSource, readOnly: boolean, sensitive: boolean, documentation: string | null }> };
...
export type ConsumerGroupsQuery = { consumerGroups: Array<{ id: string, state: ConsumerGroupState, protocol: string, coordinator: number, topics: Array<string>, lag: number, members: Array<{ id: string, clientId: string, host: string, assignments: Array<{ topic: string, partitions: Array<number> }> }>, offsets: Array<{ topic: string, partition: number, currentOffset: number, endOffset: number, lag: number, memberId: string | null }> }> };
...
export type ConsumerGroupQuery = { consumerGroup: { id: string, state: ConsumerGroupState, protocol: string, coordinator: number, topics: Array<string>, lag: number, members: Array<{ id: string, clientId: string, host: string, assignments: Array<{ topic: string, partitions: Array<number> }> }>, offsets: Array<{ topic: string, partition: number, currentOffset: number, endOffset: number, lag: number, memberId: string | null }> } | null };
...
export type ClusterThroughputQuery = { clusterThroughput: Array<{ timestamp: number, bytesIn: number, bytesOut: number, messages: number }> };
...
export type TopicThroughputQuery = { topicThroughput: Array<{ timestamp: number, bytesIn: number, bytesOut: number, messages: number }> };
...
export type AclsQuery = { acls: Array<{ principal: string, resourceType: AclResourceType, resourceName: string, patternType: AclPatternType, operation: string, permission: AclPermission, host: string }> };
