...
export type TopicListFieldsFragment = { name: string, internal: boolean, partitionCount: number, replicationFactor: number, messageCount: number, sizeBytes: number, cleanupPolicy: CleanupPolicy, retentionMs: number, consumerGroups: Array<string>, bytesInPerSec: number, messagesPerSec: number, underReplicated: boolean };
...
export type TopicsQuery = { clusterCatalog: { updatedAt: string, topics: Array<{ name: string, internal: boolean, partitionCount: number, replicationFactor: number, messageCount: number, sizeBytes: number, cleanupPolicy: CleanupPolicy, retentionMs: number, consumerGroups: Array<string>, bytesInPerSec: number, messagesPerSec: number, underReplicated: boolean }> } };
...
export type GroupLagHistoryQuery = { groupLagHistory: Array<{ timestamp: string, bytesIn: number, bytesOut: number, messages: number }> };
