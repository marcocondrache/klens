...
use klens::app::typescript::{
    ...
    GroupRowPage, GroupState, Identity, Int64, LaneHealth, MemberAssignment, OffsetChange,
    OffsetReset, PartitionRow, PrivilegeName, Record, RecordHeader, RecordOrder, RecordPage,
    ResetOffsetsRequest, ResetTo, ResyncReason, SchemaCompatibility, SchemaReference, SchemaType,
    SearchHit, SearchKind, SubjectDetail, SubjectRow, SubjectRowsResult, TailEvent, TailStart,
    TopicDetail, TopicGroupRow, TopicRate, TopicRow, TopicRowPage, TopicSortField, Update,
};
